...
4. チームA名、チームB名を設定します。
5. 再生中の時刻で、チームとプレーが一体になった2x2のクイックタグボタンを押します。
6. タグ一覧で時刻、チーム、プレー種別を確認・編集できます。
7. プレー種別、チームで絞り込めます。
8. タグの何秒前から何秒後まで再生するかを選びます。
9. **連続再生** で、該当タグを順番に再生します。
10. 必要に応じてJSONを書き出し、あとで読み込んで作業を続けます。
